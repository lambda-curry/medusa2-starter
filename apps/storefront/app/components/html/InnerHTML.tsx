...
export const ServerInnerHtml: React.FC<InnerHtmlProps> = ({
  html,
  permitRerenders,
  ...rest
...
export const RenderScripts: FC<{ html: string } & InnerHtmlProps> = ({
  html,
  ...rest
}) => {
...
export const InnerHtml: React.FC<InnerHtmlProps> = ({
  html: htmlString,
  header,
  ...rest
}) => {
