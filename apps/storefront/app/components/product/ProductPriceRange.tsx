...
export const ProductPriceRange: FC<ProductPriceRangeProps> = ({
  product,
  currencyCode,
}) => {
  const sortedVariants = useMemo(
    () => sortProductVariantsByPrice(product),
  ...
  const minPrice = useMemo(
    () => getVariantFinalPrice(minVariant),
    [sortedVariants],
  )
  const maxPrice = useMemo(
    () => getVariantFinalPrice(maxVariant),
    [sortedVariants],
  )
