...
import { type Payment } from "@libs/utils-to-merge/types"
import { useEnv } from "@ui-components/hooks/useEnv"
import { getOrderPaymentData } from "@libs/util/orders"
...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  // const { order } = await sdk.store.cart.retrieve(cartId);
...
export default function CheckoutSuccessRoute() {
  ...
  return <div>CheckoutSuccessRoute</div>
