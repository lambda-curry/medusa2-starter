...
export const ImageGalleryPhoto: FC<RenderPhotoProps> = ({ imageProps, wrapperStyle }) => {
  return (
    <div
      ...
      style={wrapperStyle}
    >
      <ImageBase loading="lazy" {...imageProps} className="!mb-0 !h-full !w-full object-cover ease-in-out" />
