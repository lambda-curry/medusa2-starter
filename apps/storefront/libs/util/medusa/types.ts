...
import type { VendorStatus } from 'medusa-plugin-markethaus/dist/models/vendor';
...
export type ProductOptionValue = MedusaClientSerialized<MedusaProductOptionValue>;
export type Customer = Omit<MedusaClientSerialized<MedusaCustomer>, 'password_hash' | 'orders'>;
...
export type ProductWithReviews = PricedProduct & { reviewStats: ProductReviewStats };

const blah2 = {} as ProductWithReviews;
...
export interface Post {
  ...
  featured_image?: Omit<Image, 'beforeInsert'>;
  title?: string;
  excerpt?: string;
