...
// export interface StoreDataResponse { // TODO: REMOVE
//   store: Store
//   site_settings: SiteSettings
...
export interface ProductCarouselPostSection
  extends DefaultPostSectionWithProductList {
  type: PostSectionType.PRODUCT_CAROUSEL
}

export interface ProductGridPostSection
  extends DefaultPostSectionWithProductList {
